...
class MainAnalyticsWidget extends StatefulWidget {
  const MainAnalyticsWidget({Key? key}) : super(key: key);

  @override
  _MainAnalyticsWidgetState createState() => _MainAnalyticsWidgetState();
}
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    24.0, 4.0, 24.0, 0.0),
                                child: Text(
                                  'Below yo uwill find reports on your company.',
                                  style:
